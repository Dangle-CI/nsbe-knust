...
import { BASE_URL, SAMPLE_DATA } from '../contestant_sample_data';
               ...
               
                {
                 voteData.map((portfolio) => {
                    return <Accordion key={portfolio.title} className='accordion'>
                        ...
                        >
                            <Typography className={classes.heading+ ' accordion-title'}>{portfolio.title}</Typography>
                        </AccordionSummary>
                        <AccordionDetails className='accordion-content'>
                            <Grid container spacing={0} className='grid-container'>
                                {portfolio.multi === true ? <MultiContestant portfolio={portfolio.title} selectionHandler={manageSelections} contestants={portfolio.contestants} /> :
                                    <SingleContestant portfolio={portfolio.title} selectionHandler={manageSelections} contestants={portfolio.contestants[0]} />
                                }
